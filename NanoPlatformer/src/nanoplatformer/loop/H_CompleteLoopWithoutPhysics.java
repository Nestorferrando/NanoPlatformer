...
public class H_CompleteLoopWithoutPhysics extends BaseGameLoop {
    ...
    public H_CompleteLoopWithoutPhysics(int framesPerSecond, IPollableInput input, ILevelHolder level, MainCharacterWithoutPhysics character, IRenderer renderer) {
