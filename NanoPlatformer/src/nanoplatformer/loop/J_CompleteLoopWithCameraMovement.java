...
public class J_CompleteLoopWithCameraMovement extends BaseGameLoop {
    ...
    public J_CompleteLoopWithCameraMovement(int framesPerSecond, IPollableInput input, ILevelHolder level, MainCharacterWithPhysics character, IRenderer renderer) {
    ...
    private void renderLevel(IRenderer renderer, ILevelHolder levelHolder,Point topLeftCorner) {
