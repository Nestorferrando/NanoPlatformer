...
public class E_SimpleLevelRenderer {
    ...
    public static void main(String[] args) {
        ...
        ILevelHolder levelHolder=createLevel(graphicsPool);

        renderLevel(renderer, levelHolder); 
    }

    private static void renderLevel(IRenderer renderer, ILevelHolder levelHolder) {
    ...
    private static ILevelHolder createLevel(IGraphicsPool graphicsPool) {
        ILevelHolder levelHolder=new ListBasedLevelHolder();
