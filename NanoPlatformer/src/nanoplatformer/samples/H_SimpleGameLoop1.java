...
import nanoplatformer.loop.CompleteLoop;
...
public class H_SimpleGameLoop1 {
    ...
    public static void main(String[] args) throws IOException {
        ...
        IMainCharacter character= new MainCharacterWithoutPhysics(32,32,graphicsPool.getGraphicsInfoFromName("dolan"));
        
        BaseGameLoop loop= new CompleteLoop(30,keyboard,levelHolder,character,renderer);
        loop.start();
    }
